          ...
          <div className={`pokemon-card-box flex ${info.types[0].type.name}`}>
            <div className="box-top">
              ...
              <div className="header">
                ...
                <div
                  className={`love-icon ${
                    lovePokemon.find((item) => item === data) ? "active" : ""
                  }`}
                  onClick={(e) => clickLove(e)}
                >
              ...
              <div className="pokemon-ball">
                ...
                <div
                  className={`ball-outside ${info.types[0].type.name}`}
                ></div>
              </div>
            </div>
            <div className="box-bottom">
              <div className="navBar">
                <div className="nav-box" onClick={clickNav}>
                  <div className={`about ${nav === "about" ? "active" : null}`}>
                    About
                  </div>
                  <div className={`moves ${nav === "moves" ? "active" : null}`}>
                    Moves
                  </div>
                </div>
              </div>
